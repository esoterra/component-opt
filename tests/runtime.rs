// This file is a copy of compile-claw's runtime tests with component opt performed before execution
use compile_claw::compile;

use component_opt::optimize_bytes;
...
impl Runtime {
    pub fn new(name: &str) -> Self {
        ...
        let component_bytes = optimize_bytes(component_bytes).unwrap();
